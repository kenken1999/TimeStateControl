...
param_s = zeros(2*l_max-1, 2*m_max-1, 2*n_max-1, 3, iteration+1);
...
%     A2 = [param_s(l_p,m,n,:,iteration) - param_s(l,m,n,:,iteration) param_s(l,m_p,n,:,iteration) - param_s(l,m,n,:,iteration) param_s(l,m,n_p,:,iteration) - param_s(l,m,n,:,iteration)];
...
%     z1_b1(j) = l_real(j) + rho_2(j,1);
%     z2_b1(j) = m_real(j) + rho_2(j,2);
%     z3_b1(j) = n_real(j) + rho_2(j,3);
