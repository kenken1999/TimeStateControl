...
for j = 1:length(k)
    ...
    f2_b(j) = 3 * param_beta(l,m,n,iteration) + rho1(j) * (param_beta(l+1,m,n,iteration) - param_beta(l,m,n,iteration))...
    ...
    f3_b(j) = 3 * param_gamma(l,m,n,iteration) + rho1(j) * (param_gamma(l+1,m,n,iteration) - param_gamma(l,m,n,iteration))...
    ...
    gmap_b(j) = 3 * param_delta(l,m,n,iteration) + rho1(j) * (param_delta(l+1,m,n,iteration) - param_delta(l,m,n,iteration))...
