...
for j = 1 : length(k1) - 1
    ...
    Ef1_1 = Ef1_1 + ( 0 - ( alpha(l,m,n) + rho1_1(j) * (alpha(l+1,m,n) - alpha(l,m,n)) + rho2_1(j) * (alpha(l,m+1,n) - alpha(l,m,n)) + rho3_1(j) * (alpha(l,m,n+1) - alpha(l,m,n))) ) ^ 2;

    Ef3_1 = Ef3_1 + ( y1(j) - (gamma(l,m,n) + rho1_1(j) * (gamma(l+1,m,n) - gamma(l,m,n)) + rho2_1(j) * (gamma(l,m+1,n) - gamma(l,m,n)) + rho3_1(j) * (gamma(l,m,n+1) - gamma(l,m,n))) ) ^ 2;

end

Ef1_1 = Ef1_1 + ( 0 - ( alpha(l2,m2,n2) + rho1_1(j+1) * (alpha(l2+1,m2,n2) - alpha(l2,m2,n2)) + rho2_1(j+1) * (alpha(l2,m2+1,n2) - alpha(l2,m2,n2)) + rho3_1(j+1) * (alpha(l2,m2,n2+1) - alpha(l2,m2,n2))) ) ^ 2;

Ef3_1 = Ef3_1 + ( y1(j+1) - (gamma(l2,m2,n2) + rho1_1(j+1) * (gamma(l2+1,m2,n2) - gamma(l2,m2,n2)) + rho2_1(j+1) * (gamma(l2,m2+1,n2) - gamma(l2,m2,n2)) + rho3_1(j+1) * (gamma(l2,m2,n2+1) - gamma(l2,m2,n2))) ) ^ 2;
...
Ef1_1_initial = double(subs(Ef1_1, [alpha(1:l_max+1,1:m_max+1,1:n_max+1)],[param_alpha(1:l_max+1,1:m_max+1,1:n_max+1,1)]));

Ef3_1_initial = double(subs(Ef3_1, [gamma(1:l_max+1,1:m_max+1,1:n_max+1)],[param_gamma(1:l_max+1,1:m_max+1,1:n_max+1,1)]));
...
for a = 1:l_max+1
    for b = 1:m_max+1
        for c = 1:n_max+1
            ...
            % DEf1_1{a,b,c} = matlabFunction(DEf1(a,b,c), 'vars', {alpha(:,:,:)});
            % DEf3_1{a,b,c} = matlabFunction(DEf3(a,b,c), 'vars', {gamma(:,:,:)});
...
for t = 1:iteration
    ...
    Ef1_1_value(t) = double(subs(Ef1_1, [alpha(1:l_max+1,1:m_max+1,1:n_max+1)],[param_alpha(1:l_max+1,1:m_max+1,1:n_max+1,t+1)]));
    
    Ef3_1_value(t) = double(subs(Ef3_1, [gamma(1:l_max+1,1:m_max+1,1:n_max+1)],[param_gamma(1:l_max+1,1:m_max+1,1:n_max+1,t+1)]));

    % Ef1_1_value(t) = double(subs(Ef1_1, [alpha(:,:,:)],[param_alpha(:,:,:,t+1)]));
    
    % Ef3_1_value(t) = double(subs(Ef3_1, [gamma(:,:,:)],[param_gamma(:,:,:,t+1)]));
...
for j = 1 : length(k2) - 1
    ...
    % Ef1_2 = Ef1_2 + ( 0 - ( (alpha(l2,m2,n2) + rho1_2(j+1) * (alpha(l2+1,m2,n2) - alpha(l2,m2,n2)) + rho2_2(j+1) * (alpha(l2,m2+1,n2) - alpha(l2,m2,n2)) + rho3_2(j+1) * (alpha(l2,m2,n2+1) - alpha(l2,m2,n2)))...
    %                     - (alpha(l,m,n) + rho1_2(j) * (alpha(l+1,m,n) - alpha(l,m,n)) + rho2_2(j) * (alpha(l,m+1,n) - alpha(l,m,n)) + rho3_2(j) * (alpha(l,m,n+1) - alpha(l,m,n))) )...
    %                     / dk2 ) ^ 2;

    % Ef3_2 = Ef3_2 + ( -u1_b2(j+1) - ( (gamma(l2,m2,n2) + rho1_2(j+1) * (gamma(l2+1,m2,n2) - gamma(l2,m2,n2)) + rho2_2(j+1) * (gamma(l2,m2+1,n2) - gamma(l2,m2,n2)) + rho3_2(j+1) * (gamma(l2,m2,n2+1) - gamma(l2,m2,n2)))...
    %                     - ( gamma(l,m,n) + rho1_2(j) * (gamma(l+1,m,n) - gamma(l,m,n)) + rho2_2(j) * (gamma(l,m+1,n) - gamma(l,m,n)) + rho3_2(j) * (gamma(l,m,n+1) - gamma(l,m,n))) )...
    %                     / dk2 ) ^ 2;

    Ef1_2 = Ef1_2 + ( 1 - ( alpha(l,m,n) + rho1_2(j) * (alpha(l+1,m,n) - alpha(l,m,n)) + rho2_2(j) * (alpha(l,m+1,n) - alpha(l,m,n)) + rho3_2(j) * (alpha(l,m,n+1) - alpha(l,m,n))) ) ^ 2;

    Ef3_2 = Ef3_2 + ( y2(j) - (gamma(l,m,n) + rho1_2(j) * (gamma(l+1,m,n) - gamma(l,m,n)) + rho2_2(j) * (gamma(l,m+1,n) - gamma(l,m,n)) + rho3_2(j) * (gamma(l,m,n+1) - gamma(l,m,n))) ) ^ 2;

end

Ef1_2 = Ef1_2 + ( 1 - ( alpha(l2,m2,n2) + rho1_2(j+1) * (alpha(l2+1,m2,n2) - alpha(l2,m2,n2)) + rho2_2(j+1) * (alpha(l2,m2+1,n2) - alpha(l2,m2,n2)) + rho3_2(j+1) * (alpha(l2,m2,n2+1) - alpha(l2,m2,n2))) ) ^ 2;

Ef3_2 = Ef3_2 + ( y2(j+1) - (gamma(l2,m2,n2) + rho1_2(j+1) * (gamma(l2+1,m2,n2) - gamma(l2,m2,n2)) + rho2_2(j+1) * (gamma(l2,m2+1,n2) - gamma(l2,m2,n2)) + rho3_2(j+1) * (gamma(l2,m2,n2+1) - gamma(l2,m2,n2))) ) ^ 2;
...
param_alpha(1:l_max+1,1:m_max+1,1:n_max+1,1) = param_alpha(1:l_max+1,1:m_max+1,1:n_max+1,iteration);
param_gamma(1:l_max+1,1:m_max+1,1:n_max+1,1) = param_gamma(1:l_max+1,1:m_max+1,1:n_max+1,iteration);
...
Ef1_2_initial = double(subs(Ef1_2, [alpha(1:l_max+1,1:m_max+1,1:n_max+1)],[param_alpha(1:l_max+1,1:m_max+1,1:n_max+1,1)]));

Ef3_2_initial = double(subs(Ef3_2, [gamma(1:l_max+1,1:m_max+1,1:n_max+1)],[param_gamma(1:l_max+1,1:m_max+1,1:n_max+1,1)]));
...
Ef1_2_value = zeros(1,iteration);
Ef3_2_value = zeros(1,iteration);
...
for a = 1:l_max+1
    for b = 1:m_max+1
        for c = 1:n_max+1
            ...
            DEf1(a,b,c) = diff(Ef1_2,alpha(a,b,c));
            DEf3(a,b,c) = diff(Ef3_2,gamma(a,b,c));
...
for t = 1:iteration
    ...
    Ef1_2_value(t) = double(subs(Ef1_2, [alpha(1:l_max+1,1:m_max+1,1:n_max+1)],[param_alpha(1:l_max+1,1:m_max+1,1:n_max+1,t+1)]));
    
    Ef3_2_value(t) = double(subs(Ef3_2, [gamma(1:l_max+1,1:m_max+1,1:n_max+1)],[param_gamma(1:l_max+1,1:m_max+1,1:n_max+1,t+1)]));
    ...
    if t > 1
        ...
        if (Ef1_2_value(t) > Ef1_2_value(t-1))
            disp('Ef1_2が増加しました')
        end
        if (Ef3_2_value(t) > Ef3_2_value(t-1))
            disp('Ef3_2が増加しました')
        end
        if (Ef1_2_value(t) > Ef1_2_value(t-1)) || (Ef3_2_value(t) > Ef3_2_value(t-1))
            iteration = t;
            disp('iterationを強制終了します')
            break
        end
