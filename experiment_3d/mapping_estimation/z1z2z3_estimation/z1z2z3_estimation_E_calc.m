...
load('function/mat/z1z2z3_estimation_func_E_calc.mat')
...
for i = 1 : imax
    ...
    if i > imax - 3
        ...
        axis([0.75 1.96 -0.1 15]) % π/2 ≒ 1.57
        ...
        plot(si_b1(1:length(k1)-1,3), g_ans(:), '--m', si_b1(1:length(k1)-1,3), g_b1(:),'o','MarkerEdgeColor','red','MarkerFaceColor','red','LineWidth', 1.5)
        xlabel("s3' = \theta")
        ylabel('g')
        legend("真値：1/cos^3(\theta')",'教師データ：g_t')
